...
class ReflexAgent(Agent):
    """
      Một tác nhân phản xạ chọn một hành động tại mỗi điểm lựa chọn bằng cách kiểm tra các lựa chọn thay thế của nó thông qua chức năng đánh giá trạng thái.

       Mã dưới đây được cung cấp như một hướng dẫn. Bạn có thể thay đổi nó theo bất kỳ cách nào bạn thấy phù hợp, miễn là bạn không chạm vào tiêu đề phương pháp của chúng tôi.
    """
...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        bestAction = maxValue(gameState, 0, -Infinity, Infinity) #bestaction lua chon toi uu cho pacman(goi ham maxvalue)
        return bestAction
